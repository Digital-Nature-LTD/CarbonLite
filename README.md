...
```html
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.21/dist/CarbonLiteSimple.min.js"></script>
```
...
```html
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.21/dist/CarbonLiteSimple.min.js?message=My Custom Message"></script>
```
...
Note that examples each show a single parameter, but you can add several using the `&` character between each parameter - `e.g. src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.21/dist/CarbonLiteSimple.min.js?timeout=45000&message=Hello, world!"`.
...
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.21/dist/CarbonLiteSimple.min.js?timeout=45000"></script>
```
...
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.21/dist/CarbonLiteSimple.min.js?messageTimeout=10000"></script>
```
...
#### Example
```html
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.21/dist/CarbonLiteSimple.min.js?message=My website is reducing carbon"></script>
```
...
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.21/dist/CarbonLiteSimple.min.js?backgroundColour=green"></script>
```
...
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.21/dist/CarbonLiteSimple.min.js?backgroundColour=%23333"></script>
```
