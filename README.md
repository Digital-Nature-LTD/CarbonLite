...
```html
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.1/dist/umd/carbonlite-simple.min.js"></script>
```
...
```html
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.1/dist/umd/carbonlite-simple.min.js?message=My Custom Message"></script>
```
...
Note that examples each show a single parameter, but you can add several using the `&` character between each parameter - `e.g. src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.1/dist/umd/carbonlite-simple.min.js?timeout=45000&message=Hello, world!"`.
...
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.1/dist/umd/carbonlite-simple.min.js?timeout=45000"></script>
```
...
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.1/dist/umd/carbonlite-simple.min.js?messageTimeout=10000"></script>
```
...
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.1/dist/umd/carbonlite-simple.min.js?backgroundColour=green"></script>
```
...
<script defer="defer" type="text/javascript" src="https://cdn.jsdelivr.net/gh/Digital-Nature-LTD/CarbonLite@v1.0.1/dist/umd/carbonlite-simple.min.js?backgroundColour=%23333"></script>
```
